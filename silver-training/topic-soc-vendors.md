...
-   **to identify and address negligent or criminal behaviors**
...
-   you share large quantities of sensitive data with other organizations
...
The functions that **your** organization require will depend on a number of factors, including but not limited to:
...
-   how well you know the range of threats posed to your organization
-   whether your requirements are unique - a generic service may suffice if your requirements are typical of other organizations
...
-   **Logs are not an end in themselves**. It’s tempting to think they are, but it’s the way they are *correlated* that provides the power of a SOC. Logs must be collected, aggregated, analyzed, stored and minimized. Most importantly, they must be available to your SOC at all times.
...
-   **Establish the basics**. Don't bother with advanced concepts until you're confident you have the basics covered. Expensive and complex SIEM tools are all the rage, often the temptation is to jump from zero to 'behavioral analytics' using an expensive SIEM that nobody understands properly. Well trained and quality staff are crucial.
...
-   data from the organization's [vulnerability management](/guidance/vulnerability-management)
...
A good SOC needs you to work with it. It's not uncommon for SOC suppliers to send their customers alerts, but to never receive a reply. Obviously, an organization should not derive any security from simply knowing that a SOC is in place.
...
In many cases, the service you are offered will be multi-tenanted, with other organizations benefiting from the threat intelligence generated from your feeds and vice versa. Provided you can gain assurance from your supplier that:
...
The starting point for negotiations may be the default service offered by a supplier. It is normal for organizations new to SOC to think that their business is somehow unique, but do not underestimate the benefits which a default service can deliver. Listen to what is provided by default and use your technical experts to analyze and identify any adaptations needed in order to meet your own business requirements. This is the cheapest and easiest approach to take.
...
-   the boundary interfaces and inter-relationships with any network operations or incident response capabilities within your organization
